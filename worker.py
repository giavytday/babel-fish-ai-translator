...
# Function for Translation (The "Brain")
...
# Function for Speech-to-Text (The "Ears")
def speech_to_text(audio_binary):
    # Set up Watson Speech-to-Text HTTP Api url
    base_url = 'http://speech-to-text.29ddgren2swh.svc.cluster.local'
    ...
    # Send a HTTP Post request containing the audio data
...
def text_to_speech(text, voice=""):
    ...
    base_url = 'http://text-to-speech.29ddgren2swh.svc.cluster.local'
